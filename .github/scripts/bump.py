...
APPS = {
    "agent": {
        ...
        "manifest": "braiins-braiins-manager-agent/umbrel-app.yml",
        "compose": "braiins-braiins-manager-agent/docker-compose.yml",
    ...
    "toolbox": {
        ...
        "manifest": "braiins-braiins-toolbox/umbrel-app.yml",
        "compose": "braiins-braiins-toolbox/docker-compose.yml",
